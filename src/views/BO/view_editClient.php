            ...
            <nav class="navbar navbar-inverse navbar-fixed-top">
                <div class="container">
                    <div class="navbar-header">
                        ...
                        <a class="nav clickNCook navbar-brand" href="../../../client/viewShop.php" title="<?php echo TXT_EXTENSIONS_SHOPG; ?>">Click'N Cook</a>
                    </div>
                    <div id="navbar" class="collapse navbar-collapse">
                        <ul class="nav navbar-nav">
                            <li>
                                <a  href="../../../client/viewShop.php" class="glyphicon glyphicon-shopping-cart" title="<?php echo TXT_EXTENSIONS_SHOPG; ?>"></a>
                            </li>
                        </ul>
            ...
            <div class="container">
                ...
                <div id="jumbo-01" class="jumbotron" style="border-radius: 50px">
                    ...
                    <div class="d-flex justify-content-center align-items-stretch">
                        ...
                        <form action="/assets/editClient.php" method="POST">
                            ...
                            <div  class="form-label-group">
                                <label for="address"><?php echo TXT_REGISTER_PLACEHOLDER5; ?></label>
                                <input type="text" id="address" name="address" class="form-control" required="required" value="<?php echo $dataUser['address']?>">
                            </div>
                            <div class="form-label-group">
                        ...
                        <div class="text-center">
                            <?php
                                echo '<a class="d-block small mt-3" href="view_specClient.php?idUser=' . $dataUser['id'] . '">' . TXT_BO_BTYA . '</a>';
                            ?>
                        </div>
