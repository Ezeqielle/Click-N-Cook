            ...
            <div class="container">
                ...
                <div class="row">
                    <article class="col-lg-6 radius">
                        <center>
                            <h1 id="title-01" class="display-3 text-bold"><?php echo TXT_BO_ABREAK; ?></h1>
                            <a class="btn btn-default btn-sm" href="view_allBreakdown.php?idTruck=<?php echo $_SESSION['truck']; ?>"><?php echo TXT_BO_BACK; ?></a>
                        </center>
                    </article>
                </div>
                ...
                <div id="jumbo-01" class="jumbotron" style="border-radius: 50px">
                    <form action="/assets/addBreakdown.php" method="post">
                        <form>
                            ...
                            <label for="inputRepaired"><?php echo TXT_BO_REPAIR; ?> <span class="required">*</span> </label>
                            <select name="repaired" class="form-control">
                                <option value="1" selected><?php echo TXT_BO_REPAIR; ?></option>
                                <option value="0"><?php echo TXT_BO_NREPAIR; ?></option>
                            </select>
                            ...
                            <input type="number" id="price"
                                   ...
                                   required="required"
                                   autofocus="autofocus"
                                   value="<?php echo (isset($_SESSION["errorsInput"]))?$_SESSION["errorsInput"]["price"]:"";?>"></br>
