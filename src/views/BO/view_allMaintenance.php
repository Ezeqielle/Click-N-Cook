...
$pdo = connectDB();
$query = $pdo->prepare("SELECT * FROM MAINTENANCE WHERE idTruck = $truck");
$query->execute();
        ...
        <div class="container">
            ...
            <div class="row">
                <article class="col-lg-6 radius">
                    <center>
                        <h1><?php echo TXT_BO_MV; ?></h1>
                        <a class="btn btn-default btn-sm" href="view_specTruck.php?idTruck=<?php echo $truck; ?>"><?php echo TXT_BO_BACK; ?></a>
                        <a class="btn btn-default btn-sm" href="view_newMaintenance.php"><?php echo TXT_BO_ADD; ?></a>
                    </center>
                </article>
            </div>
        </div>
            ...
            <section class="listArray">
                <table class="table">
                    ...
                    <tr>
                        ...
                        <th scope="col"><?php echo TXT_BO_GAR; ?></th>
