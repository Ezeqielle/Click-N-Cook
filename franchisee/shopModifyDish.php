        ...
        <div class="row">
            ...
            <section class="col-lg-6">
                <div class="row">
                    ...
                    echo '<label>' . TXT_ADMINS_NAME . '</label><input name="name" value="' . $dishData['name'] . '" class="form-control">';
                    echo '<label>' . TXT_ADMINS_PRICE . '</label><input name="price" value="' . $dishData['price'] . '" class="form-control">';
                    if($dishData['type'] != NULL) {
                        echo '<label>' . TXT_ADMINS_QTY . '</label><input type="hidden" name="quantity" value="' . $dishData['quantity'] . '"> ' . $dishData['quantity'] . '</br>';
                    } else {
                        echo '<label>' . TXT_ADMINS_QTY . '</label><input name="quantity" value="' . $dishData['quantity'] . '" class="form-control">';
                    }
