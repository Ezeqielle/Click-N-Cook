            ...
            <section class="col-lg-6">
                    ...
                    <article class="col-lg-12 radius">
                        <center>
                            ...
                            if($reqExistOrder->rowCount() > 0) {
                                echo '<a href="shopPaymentClient.php" class="btn btn-default btn-sm">' . TXT_CLIENT_BILL . '</a>';
                            }
                            ...
                            if(isset($_GET['insert']) AND !empty($_GET['insert']) AND $_GET['insert'] == 'error') {
                                echo '<div class="alert alert-danger alert-dismissible">
                                      <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                                      <strong>' . TXT_INDEX_ERROR . '</strong> ' . TXT_INDEX_ERROR1 . '
                                  </div>';
                            }
                            ?>
                        </center>
                ...
                <article class="col-lg-6 radius" style="border-left-width: 0;">
                    ...
                    if(($menuVerify = $reqMenu->fetchALL()) != NULL) {
                        ...
                        if($emptyMenu == 1) {
                            echo '<center>';
                                echo '<label>' . TXT_CLIENT_STOCK . '</label> <br>';
                            echo '</center>';
                        }
                        $reqMenu->closeCursor();
                        echo '</div>';
