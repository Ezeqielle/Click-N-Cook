...
if (isset($_SESSION['id']) AND !empty($_SESSION['id']) AND $_SESSION['administrator'] == 2){
    ...
    if (!empty($_POST["firstname"])
        ...
        if ($error){
            ...
            header("Location: /BO/view_editClient.php?idUser=" . $user);
        }else{
            ...
            $queryPrepared = $pdo->prepare('UPDATE CLIENT SET lastName = :lastName, firstName = :firstName, contactNumber = :contactNumber, pwd = :password, address = :address WHERE id = :id');
            ...
            header('Location: /BO/view_specClient.php?idUser=' . $user);
