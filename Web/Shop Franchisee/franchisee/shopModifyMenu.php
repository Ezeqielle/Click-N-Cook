        ...
        <div class="row">
            ...
            <section class="col-lg-6">
                <div class="row">
                    ...
                    echo '<label>Name :</label><input name="name" value="' . $menuData['name'] . '" class="form-control">';
                    echo '<label>Price :</label><input name="price" value="' . $menuData['price'] . '" class="form-control">';
