...
fetch("../stripeApi/server/php/stripe-key")
...
var handleAction = function(clientSecret) {
    ...
    stripe.handleCardAction(clientSecret).then(function(data) {
        if (data.error) {
            ...
            fetch("../stripeApi/server/php/pay", {
                method: "POST",
                headers: {
    ...
    stripe
        ...
        .then(function(result) {
            if (result.error) {
                ...
                return fetch("../stripeApi/server/php/pay", {
                    method: "POST",
                    headers: {
                        "Content-Type": "application/json"
                    },
        ...
        .then(function(paymentData) {
            if (paymentData.requiresAction) {
                ...
                window.location.replace("../client/shopClient.php?payment=success");
            }
        });
};
