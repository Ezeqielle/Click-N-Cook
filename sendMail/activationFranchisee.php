...
$verif = $db->prepare('SELECT verif_key, active FROM FRANCHISEE WHERE email = ?');
...
if ($accountStatus == '1') {
    ...
    $char = TXT_MAIL_TY;
    $verif = $db->prepare('UPDATE FRANCHISEE SET active = 1, verif_key = NULL WHERE email = ?');
    ...
    <div class="container height">
        <div class="card card-container">
            <form class="form-signin" method="post">
                ...
                <a role="button" href="../login/indexFranchisee.php">
